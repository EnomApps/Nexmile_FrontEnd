...
/// server posts to; this is only ever read by a customer.
const String _ordersChannelName = 'Order updates';
const String _ordersChannelDescription =
    'Order accepted, rider assigned, picked up and delivered.';
...
class FirebasePushService implements PushService {
  ...
  void _listen() {
    ...
    // lands while the customer is looking at the app would otherwise be
    // invisible.
