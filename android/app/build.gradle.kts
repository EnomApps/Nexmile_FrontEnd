...
if (googleServicesFile.exists()) {
    ...
    logger.lifecycle(
        "Nexmile: android/app/google-services.json is missing — building " +
            "without Firebase. Push notifications will not arrive.",
    )
}

android {
    namespace = "com.nexmile.app"
